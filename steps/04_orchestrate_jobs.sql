...
, vacation_spots.korean_restaurant_cnt = harmonized_vacation_spots.korean_restaurant_cnt  WHEN NOT MATCHED THEN 
    INSERT VALUES (
...
and (zoo_cnt > 0 or aquarium_cnt > 0)        limit 10);


      if (:options = '[]') then
        CALL SYSTEM$SEND_EMAIL(
            'email_integration',
            'romaric.sokhan@snowflake.com', -- INSERT YOUR EMAIL HERE
